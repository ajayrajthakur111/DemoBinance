      ...
      <div className='crypto-header'>
       ...
       <div  className='crypto-listing-content'>
       {
              cryptoData.map((item) => (
                <div key={item.symbol} className='crypto-item'>
                   ...
                   <div>
                       ...
                       <span   className={`crypto-change  ${item.change.includes("-") ? "red-color" : "green-color"}` } > {item.change} </span>
        ...
        <div className="news-title">
          ...
          <p> Vitalik Buterin Predicts Release of Tornado Cash Team Members </p>

          <p> U.S. Stock Market Opens With Gains As AI Sector Rises</p>

          <p> Bitcoin Donation Made To Support Fund For Ross Ulbricht </p>
          <p> Ethereum Foundation&apos;s Role in Governance Reform Debated </p>
        </div>
      </div>
    </div>
    <Accordion/>
