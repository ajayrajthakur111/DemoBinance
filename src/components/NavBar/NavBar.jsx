  ...
  return (
    <nav className="navbar">
      <div className="navbar-left">
        ...
        <div style={{ position: "relative" }}>
          <span>
            ...
            >
              <path
                d="M11.987 15.217L7.751 11.21a1 1 0 01-.293-1.322 1 1 0 011.322-.292l4.534 4.151 4.404-4.405a1 1 0 011.322.326 1 1 0 01-.291 1.296l-4.429 4.169c-.076.076-.17.119-.265.125a1 1 0 01-.769-.353z"
                fill="white"
              />
            </svg>
          </span>
      ...
      <div className="navbar-right">
        ...
        >
          <path
            d="M20 21l-5.35-5.35a8 8 0 10-1.42 1.42L21 20.59a1 1 0 001.42 0 1 1 0 000-1.42zm-9-2a6 6 0 116-6 6 6 0 01-6 6z"
            fill="#fff"
          />
        </svg>
